        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div>
              ...
              <CardDescription>
                {models.length} modelos registrados
              </CardDescription>
            </div>
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              <DialogTrigger asChild>
        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div>
              ...
              <CardDescription>
                {costCenters.length} centros de costo registrados
              </CardDescription>
            </div>
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              <DialogTrigger asChild>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Ingrese los datos del centro de costo
                  </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleAdd} className="space-y-4">
                  <div className="grid gap-4 sm:grid-cols-2">
    ...
    <div className="p-4 lg:p-6 space-y-6">
      <div>
        ...
        <p className="text-text-secondary mt-1">
          Gestione proveedores, marcas, modelos, empleados, centros de costo y
          bodegas
        </p>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div>
              ...
              <CardDescription>
                {warehouses.length} bodegas registradas
              </CardDescription>
            </div>
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              <DialogTrigger asChild>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Ingrese los datos de la bodega
                  </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleAdd} className="space-y-4">
                  <div className="grid gap-4 sm:grid-cols-2">
