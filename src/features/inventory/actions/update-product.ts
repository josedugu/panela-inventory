...
export async function updateProductAction(id: string, formData: FormData) {
  ...
  try {
    ...
    if (validatedData.data.imei !== undefined)
      updateData.imei = validatedData.data.imei;
    if (validatedData.data.precio !== undefined)
      updateData.precio = validatedData.data.precio;
