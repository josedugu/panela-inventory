...
const mockNotifications: Notification[] = [
  {
    ...
    title: "Stock Bajo",
    description:
      "Galaxy Buds 2 tiene solo 5 unidades en stock. Se recomienda realizar un nuevo pedido pronto.",
    time: "Hace 5 min",
    date: "2024-01-20",
    read: false,
    type: "warning",
  },
  {
    ...
    title: "Nueva Venta",
    description:
      "Se registró una venta de iPhone 15 Pro Max por un valor de $1,199.99",
    time: "Hace 15 min",
    date: "2024-01-20",
    read: false,
    type: "success",
  },
  {
    ...
    description:
      "Se agregaron 50 nuevas unidades de Samsung Galaxy S24 Ultra al inventario",
    time: "Hace 1 hora",
    date: "2024-01-20",
    read: true,
    type: "info",
  },
  {
    ...
    description:
      "El pedido #ORD-2024-042 ha sido procesado exitosamente y está listo para envío",
    time: "Hace 2 horas",
    date: "2024-01-20",
    read: true,
    type: "success",
  },
  {
    ...
    description:
      "AirPods Pro 2 se encuentra agotado. Se requiere reabastecimiento urgente.",
    time: "Hace 3 horas",
    date: "2024-01-20",
    read: true,
    type: "error",
  },
  {
    ...
    description:
      "Se ha agregado un nuevo proveedor: Xiaomi Corporation al sistema",
    time: "Hace 5 horas",
    date: "2024-01-20",
    read: true,
    type: "info",
  },
  {
    ...
    description:
      "Los precios de 12 productos han sido actualizados según la nueva lista de precios",
    time: "Hace 1 día",
    date: "2024-01-19",
    read: true,
    type: "info",
  ...
  },
  {
    ...
    description:
      "Es momento de realizar el conteo físico mensual de inventario",
    time: "Hace 2 días",
    date: "2024-01-18",
    read: true,
    type: "warning",
