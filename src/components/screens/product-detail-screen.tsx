        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="aspect-video bg-surface-2 rounded-lg overflow-hidden mb-4">
                <img
                  src={productImages[0]}
                  alt="Product"
              ...
              <div className="grid grid-cols-3 gap-3">
                {productImages.map((image, i) => (
                  <div
                    key={i}
                    className="aspect-square bg-surface-2 rounded-lg overflow-hidden cursor-pointer hover:ring-2 ring-primary transition-all"
                  >
                    <img
                      src={image}
                      alt={`Product ${i + 1}`}
                ...
                <TabsContent value="description" className="space-y-4 mt-4">
                  <div>
                    ...
                    <p className="text-text-secondary mt-2">
                      ...
                      256GB storage, you'll have plenty of space for all your photos,
                      videos, and apps.
                    </p>
                  </div>
                  <Separator />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-3 mt-3">
                      <div className="flex justify-between text-sm">
                        <span className="text-text-secondary">Stock adjusted</span>
                        <span>Feb 12, 2025</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-text-secondary">Price updated</span>
                        <span>Feb 8, 2025</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-text-secondary">Product added</span>
